...
public class DicFhirClientConfig
{
	...
	@ProcessDocumentation(processNames = {
			"medizininformatik-initiativede_executeDataSharing" }, description = "Proxy location, set if the server containing the FHIR data can only be reached through a proxy", example = "http://proxy.foo:8080")
	...
	@ProcessDocumentation(processNames = {
			"medizininformatik-initiativede_executeDataSharing" }, description = "Proxy location, set if the oidc provider can only be reached through a proxy", example = "http://proxy.foo:8080")
