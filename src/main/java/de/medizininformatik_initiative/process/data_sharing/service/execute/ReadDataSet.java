...
public class ReadDataSet extends AbstractServiceDelegate implements InitializingBean
{
	...
	public ReadDataSet(ProcessPluginApi api, FhirClientFactory fhirClientFactory, boolean fhirBinaryStreamReadEnabled,
	...
	protected void doExecute(DelegateExecution execution, Variables variables)
	{
		...
		try
		{
			...
			variables.setResource(ConstantsDataSharing.BPMN_EXECUTION_VARIABLE_INITIAL_DOCUMENT_REFERENCE,
					documentReference);
			variables.setResourceList(ConstantsDataSharing.BPMN_EXECUTION_VARIABLE_INITIAL_DATA_RESOURCES, resources);
		}
